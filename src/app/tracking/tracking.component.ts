...
export class TrackingComponent implements OnInit, OnChanges, AfterViewInit {
        ...
        this.missionResponses.forEach(mr => {
            if (mr.tracking) {
                let marker = new RichMarker({
                    ...
                    content: '<div><div class="label_content">' + mr.saruser.name // the data title you want to display
                    + '</div></div>'
                });
